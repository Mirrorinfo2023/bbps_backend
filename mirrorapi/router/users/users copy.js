...
// Multer instance with dynamic path
const fileUpload = configureMulter((req) => {
    const userId = req.body.user_id || "guest"; // fallback if no id
    return path.join(process.cwd(), "uploads", "kyc", String(userId));
...
users.post('/7e0f025e644befa1fce101beb075a6acc6360b16', authenticateJWT, logMiddleware, async (req, res) => {
    ...
    loginController.updateUserStatus(req.body, res).then(data => res.json(data))
        .catch(error => {
...
users.post('/73c0a707a700129fd2b4f7cb4b982d3a549904b1', logMiddleware, (req, res) => {
    ...
    mpinController.resetMpin(req.body, res).then(data => res.json(data))
        .catch(error => {
...
users.post('/admin_login', logMiddleware, (req, res) => {
    ...
    loginController.admin_login(req.body, res).then(data => res.json(data));
});

users.post('/register', (req, res) => {
    const ipAddress = req.clientIpAddress;
    registerController.register(req.body, res, ipAddress).then(data => res.json(data));
});

users.post('/register-test', (req, res) => {
    const ipAddress = req.clientIpAddress;
    registerController.registerTest(req.body, res, ipAddress).then(data => res.json(data));
});


users.post('/reffer-by', logMiddleware, (req, res) => {
    const ipAddress = req.clientIpAddress;
    registerController.refferedBy(req.body, res, ipAddress).then(data => res.json(data));
});

users.post('/get-user-details', (req, res) => {
    registerController.getUserDetails(req.body, res).then(data => res.json(data));
});
...
users.post('/get-mpin', (req, res) => {
    ...
    mpinController.getMpin(req.body, res).then(data => res.json(data));
});
...
// 	kycController.uploadKyc(panImage,aadharImage,aadharBackImage,checkbookImage,combinedData,res ).then(data => res.json(data));

// });


users.post('/upload-kyc', fileUpload, async (req, res) => {
    ...
    const aadharBackImage = aadharBack.filename;
    const checkbookImage = checkbook.filename;
    kycController.uploadKyc(panImage, aadharImage, aadharBackImage, checkbookImage, req.body, res).then(data => res.json(data));
...
users.post('/get-kyc', async (req, res) => {
    ...
    kycController.getKyc(req.body, res).then(data => res.json(data));
});
...
users.post('/get-kyc-report', async (req, res) => {
    ...
    kycController.getKycReport(req.body, res).then(data => res.json(data));
});

users.post('/update-kyc-status', async (req, res) => {

    kycController.updateKycStatus(req.body, res).then(data => res.json(data));
});
...
users.post('/get-profile', async (req, res) => {
    ...
    loginController.getProfile(req.body, res).then(data => res.json(data));
});
...
users.post('/update-user-profile', fileUpload1, async (req, res) => {
    ...
    const fileName = file;
    loginController.updateProfile(fileName, req.body, res).then(data => res.json(data));
});


users.post('/update-profile-userinfo', async (req, res) => {

    loginController.updateProfileUserInfo(req.body, res).then(data => res.json(data));
});

users.post('/get-profile-userinfo', async (req, res) => {

    loginController.getProfileUserDetails(req.body, res).then(data => res.json(data));
...
users.post('/get-user-old-income', async (req, res) => {
    ...
    oldIncomeController.getIncome(req.body, res).then(data => res.json(data));
});


users.post('/check-old-income-exists', async (req, res) => {

    oldIncomeController.checkIncome(req.body, res).then(data => res.json(data));
});


users.post('/credit-debit-income-to-user', async (req, res) => {

    oldIncomeController.creditDebitIncomeToUser(req.body, res).then(data => res.json(data));
});


users.post('/admin-reset-password', (req, res) => {

    resetController.adminResetPassword(req.body, res).then(data => res.json(data));
});



users.post('/update-user-info-admin', (req, res) => {
    loginController.updateUserDetails(req.body, res).then(data => res.json(data));
});

users.post('/check-mobileOrEmail-admin', (req, res) => {
    loginController.checkMobileOrEmail(req.body, res).then(data => res.json(data));
});

users.post('/update-kyc', async (req, res) => {

    kycController.updateKyc(req.body, res).then(data => res.json(data));
});

users.post('/get-qrcode', (req, res) => {
    QrGenerateController.getQrCode(req.body, res).then(data => res.json(data));
});


users.post('/unblock-user', (req, res) => {
    loginController.unblockByUser(req.body, res).then(data => res.json(data));
});

users.post('/unblock-user-test', (req, res) => {
    loginController.unblockByUserTest(req.body, res).then(data => res.json(data));
});
users.post('/go-to-shop', async (req, res) => {

    registerController.shopingPortalLogin(req.body, res).then(data => res.json(data));
});

users.post('/deactivate-user', (req, res) => {
    loginController.deactiveUser(req.body, res).then(data => res.json(data));
});

users.post('/get-dashboard-summary', async (req, res) => {

    dashboardController.getDashboard(req.body, res).then(data => res.json(data));
});

users.post('/my-details', async (req, res) => {

    dashboardController.getMyDashboard(req.body, res).then(data => res.json(data));
});
...
users.post('/admin-dashboard', async (req, res) => {
    ...
    dashboardController.getDashboardAdmin(req.body, res).then(data => res.json(data));
});

users.post('/getDashboard_API', async (req, res) => {

    dashboardController.getDashboardAPI(req.body, res).then(data => res.json(data));
});
